...
export class YulStatements extends SlangNode {
    constructor(ast, options) {
        super(ast, true);
        this.kind = NonterminalKind.YulStatements;
        this.items = ast.items.map((item) => extractVariant(new YulStatement(item, options)));
    }
...
//# sourceMappingURL=YulStatements.js.map